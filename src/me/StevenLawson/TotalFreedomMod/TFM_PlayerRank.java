...
public enum TFM_PlayerRank
{
    ...
    NOOB("a " + ChatColor.GOLD + "Noob", ChatColor.GOLD + "[Noob]");
    ...
    public static TFM_PlayerRank fromSender(CommandSender sender)
    {
        ...
        if (entry != null && entry.isActivated())
        {
            ...
            if (TFM_ConfigEntry.PLAYER_IS_HONORARY_SENIOR_ADMIN.getBoolean())
            {
                return HSRA;
            }    
        ...
        else
        {
            ...
            if (TFM_ConfigEntry.PLAYER_IS_NOOB.getBoolean())
            {
                rank = NOOB;
            }
            else
