...
public class TotalFreedomMod extends JavaPlugin
{
    ...
    public static final String SMITE_REASON = ChatColor.GRAY + "Please add a smite reason";
    //
    ...
    public static String buildCreator = "packeretteswan";
    //
    ...
    {
        TFM_Log.info("*****************************************************", true);
        TFM_Log.info("*             PacksFreedomMod activated             *", true);
        TFM_Log.info("*              Made by packeretteswan               *", true);
        TFM_Log.info("* - - - - - - - - - - - - - - - - - - - - - - - - - *", true);
        TFM_Log.info("*        TotalFreedomMod origanally made by:        *", true);
        TFM_Log.info("*           Madgeek1450 and DarthSalamon            *", true);
        TFM_Log.info("*****************************************************", true);
    ...
    public void onDisable()
    {
        ...
        TFM_Log.info("*****************************************************", true);
        TFM_Log.info("*           PacksFreedomMod deactivated             *", true);
        TFM_Log.info("*              Made by packeretteswan               *", true);
        TFM_Log.info("* - - - - - - - - - - - - - - - - - - - - - - - - - *", true);
        TFM_Log.info("*        TotalFreedomMod origanally made by:        *", true);
        TFM_Log.info("*           Madgeek1450 and DarthSalamon            *", true);
