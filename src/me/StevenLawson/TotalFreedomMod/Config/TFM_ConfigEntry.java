...
public enum TFM_ConfigEntry
{
    ...
    //
    PLAYER_IS_NOOB(Boolean.class, "player.is_noob"),
    PLAYER_IS_SYSTEM_ADMIN(Boolean.class, "player.is.sys_admin"),
    PLAYER_IS_EXECUTIVE(Boolean.class, "player.is.master_builder"),
    PLAYER_IS_HONORARY_SENIOR_ADMIN(Boolean.class, "player.is.honorary_senior_admin"),
    PLAYER_IS_MASTERBUILDER(Boolean.class, "player.is.master_builder");
    //
